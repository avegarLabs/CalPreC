...
public class InsertarInversionistaRVController implements Initializable {

    private static SessionFactory sf;
    public NuevaObraRenglonController entidadController;
    @FXML
    ...
    private Inversionista newEntidad;
     ...
     */
    public void saveEntidad(Inversionista entidad) {
        Session session = ConnectionModel.createAppConnection().openSession();
    ...
    void handeleUpdateAction(ActionEvent event) {
        ...
        newEntidad = new Inversionista();
        newEntidad.setCodigo(field_codigo.getText());
        newEntidad.setDescripcion(text_descripcion.getText());
        saveEntidad(newEntidad);

        entidadController.combo_inversionista.setItems(entidadController.getListInversionista());
        entidadController.combo_inversionista.getSelectionModel().select(field_codigo.getText() + " - " + text_descripcion.getText());
    ...
    public void pasarParametros(NuevaObraRenglonController controller) {
