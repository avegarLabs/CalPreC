...
public class SuministrosInRVUpdateRVController implements Initializable {

    private static SessionFactory sf;
    @FXML
    public Label temp;
    SuministrosInRVUpdateRVController suministrosInRVUpdateController;
    RenVarianteToRenglonObraUpdateController renVarianteToUnidadObraUpdateControllerSum;
    @FXML
        ...
        dataTable.setOnMouseClicked(event -> {
            ...
            sumRVView.getCodigo().setOnMouseClicked(event1 -> {
                if (!sumRVView.getCodigo().isSelected()) {
                    try {
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("SuministroBajoEspecificacionComponentUpdateRV.fxml"));
                        Parent proot = loader.load();
                        BajoEspecificacionControllerComponetUpdateRV controller = loader.getController();
    ...
    public void datosRV(RenVarianteToRenglonObraUpdateController renVarianteToUnidadObraUpdateController, Integer id, double cant, int idOb) {
        idRV = id;
        cantid = cant;
    ...
    public void handleAddSuminstrosinRV(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("SuministroBajoEspecificacionComponentUpdateRVAdd.fxml"));
            Parent proot = loader.load();
            BajoEspecificacionControllerComponetUpdateRVAdd controller = loader.getController();
