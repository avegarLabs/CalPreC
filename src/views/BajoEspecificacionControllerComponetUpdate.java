...
public class BajoEspecificacionControllerComponetUpdate implements Initializable {

    private static SessionFactory sf;
    public Integer idObra;
    public Obra obraToChek;
    SuministrosInRVUpdateController suministrosInRVUpdateController;
    BajoEspecificacionControllerComponetUpdate bajoEspecificacionControllerComponetUpdate;
    ...
    public void pasarDatos(SuministrosInRVUpdateController suministrosInRVController, SumRVView sumRVView, int idOb) {
    ...
    public void searchView(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("searhSuministroUpdate.fxml"));
            Parent proot = loader.load();
            SearchSuminitrosUpdateController controller = loader.getController();
    ...
    public void handleBajoAddSum(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("nuevoSuminitroFromBajoEspUPDATE.fxml"));
            Parent proot = loader.load();
            NuevoSuministroFromBajoUpdateController controller = loader.getController();
