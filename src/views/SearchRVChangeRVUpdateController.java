...
public class SearchRVChangeRVUpdateController implements Initializable {
    private static SessionFactory sf;
    RenVarianteToRenglonObraUpdateController renVarianteToRenglonObraUpdateController;
    @FXML
    private VBox box;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        dataTable.setOnMouseClicked(event -> {
            if (event.getClickCount() == 2 && dataTable.getSelectionModel() != null) {
                ...
                renVarianteToRenglonObraUpdateController.getRenglonVarianteFronHelp(renglonvariante);
    ...
    public void setRVDatos(RenVarianteToRenglonObraUpdateController renglonObraController, String pattern, int idObra) {
        renVarianteToRenglonObraUpdateController = renglonObraController;
        loadDataRenglones();
