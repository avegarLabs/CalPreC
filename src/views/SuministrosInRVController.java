...
public class SuministrosInRVController implements Initializable {

    private static SessionFactory sf;
    @FXML
    public Label temp;
    SuministrosInRVController suministrosInRVController;
    RenVarianteToUnidadObraController renVarianteToUnidadObraControllerSum;
    @FXML
        ...
        dataTable.setOnMouseClicked(event -> {
            ...
            sumRVView.getCodigo().setOnMouseClicked(event1 -> {
                if (!sumRVView.getCodigo().isSelected()) {
                    try {
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("SuministroBajoEspecificacionComponent.fxml"));
                        Parent proot = loader.load();
                        BajoEspecificacionControllerComponet controller = loader.getController();
    ...
    public void datosRV(RenVarianteToUnidadObraController renVarianteToUnidadObraController, Integer id, double cant, int idObra) {
        idRV = id;
        cantid = cant;
        ...
        renVarianteToUnidadObraControllerSum = renVarianteToUnidadObraController;
    }
    ...
    public void saveUpdateResources(javafx.event.ActionEvent event) {
        ...
        renVarianteToUnidadObraControllerSum.createBajoespecificacionList(updateList);
    ...
    public void handleAddRecursoAction(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("SuministroBajoEspecificacionComponentAdd.fxml"));
            Parent proot = loader.load();
            BajoEspecificacionControllerComponetAdd controller = loader.getController();
