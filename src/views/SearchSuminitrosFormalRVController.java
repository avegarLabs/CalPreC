...
public class SearchSuminitrosFormalRVController implements Initializable {

    BajoEspecificacionRenglonController suministrosInRVControllerSearch;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(BajoEspecificacionRenglonController suministrosInRVController) {
        loadDatos();
