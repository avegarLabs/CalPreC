...
public class BajoEspecificacionControllerComponetAdd implements Initializable {

    private static SessionFactory sf;
    public Integer idObra;
    public Obra obraToCheck;
    SuministrosInRVController suministrosInRVController2;
    BajoEspecificacionControllerComponetAdd bajoEspecificacionControllerComponet;
    ...
    public void pasarDatos(SuministrosInRVController suministrosInRVController, int idOb) {
    ...
    public void searchView(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("searhSuministroAdd.fxml"));
            Parent proot = loader.load();
            SearchSuminitrosAddController controller = loader.getController();
    ...
    public void handleBajoAddSum(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("nuevoSuminitroFromBajoEspAdd.fxml"));
            Parent proot = loader.load();
            NuevoSuministroFromBajoControllerAdd controller = loader.getController();
