...
public class AgrupacionEspecificaController implements Initializable {

    private static SessionFactory sf;
    public NuevaUnidadObraController nuevaController;
    @FXML
    ...
    public ArrayList<Subgenerica> itemSubgen(String code) {
        ...
        try {
            ...
            subgenericaArrayList = (ArrayList<Subgenerica>) session.createQuery(" FROM Subgenerica ").getResultList();
            tx.commit();
            session.close();
    ...
    public void pasarEspecialidad(NuevaUnidadObraController controller, String codeEsp) {
