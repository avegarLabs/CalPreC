...
public class SearchRVUOUpdateController implements Initializable {
    private static SessionFactory sf;
    public RenglonVarianteView renglon;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        dataTable.setOnMouseClicked(event -> {
            if (event.getClickCount() == 2 && dataTable.getSelectionModel() != null) {
                ...
                renVarianteToUnidadObraUpdateController.getRenglonVarianteFronHelp(renglonvariante);
    ...
    public void setRVDatos(RenVarianteToUnidadObraUpdateController controller, String pattern, int idObra) {
        renVarianteToUnidadObraUpdateController = controller;
        loadDataRenglones();
