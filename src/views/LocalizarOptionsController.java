...
public class LocalizarOptionsController implements Initializable {
    ...
    public void handleGetSuministros(ActionEvent event) {
        ...
        if (fielSearch.getText().isEmpty() == true) {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("searchResponse.fxml"));
                Parent proot = loader.load();

                SearchResponseController searchResponseController = loader.getController();
