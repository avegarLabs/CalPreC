...
public class SearchRVChangeRVController implements Initializable {
    RenVarianteToRenglonObraController renVarianteToRenglonObraController;
    @FXML
    private VBox box;
    @FXML
    ...
    public void setRVDatos(RenVarianteToRenglonObraController renglonObraController, String pattern, int idObra) {
