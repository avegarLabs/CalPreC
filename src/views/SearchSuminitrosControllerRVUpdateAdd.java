...
public class SearchSuminitrosControllerRVUpdateAdd implements Initializable {

    private static SessionFactory sf;
    BajoEspecificacionControllerComponetUpdateRVAdd suministrosInRVControllerSearch;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(BajoEspecificacionControllerComponetUpdateRVAdd suministrosInRVController) {
