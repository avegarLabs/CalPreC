...
public class NuevoSemielaboradoController implements Initializable {
    ...
    public void pasarParametros(int id, String pert) {
        idObra = id;
        pertenece = pert;

        getAllSuminitros(pertenece);
        ...
        suministrosViewObservableList = utilCalcSingelton.getSuministrosViewObservableList(pertenece);
    ...
    public void handleNewSuministroSemielaborado(ActionEvent event) {
        ...
        if (labelpeso.getText() != null) {
            ...
            suministrossemielaborados.setPeso(valnull);
        }
        ...
        if (getRecursosByCode(suministrossemielaborados.getCodigo()) == null) {
            ...
            if (inserted != null && dataTable.getItems() != null) {
                ...
                Stage stage = (Stage) btn_modificar.getScene().getWindow();
                stage.close();
            }
