...
public class PlanificarRecursosRenglonesThread extends Thread {
    ...
    public PlanificarRecursosRenglonesThread(int unidadId, Integer idcertP, Date desdeDateP, Date hastaDataP, Double cant, Double valTo) {
        idUnid = unidadId;
        idCer = idcertP;
        ini = desdeDateP;
        fin = hastaDataP;
