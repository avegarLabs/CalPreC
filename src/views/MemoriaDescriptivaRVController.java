...
import models.Memoriadescriptivarv;
...
public class MemoriaDescriptivaRVController implements Initializable {
    ...
    private int idUO;
    private Memoriadescriptivarv memoriadescriptiva;
    private ArrayList<Memoriadescriptivarv> memoriadescriptivaArrayList;
    private ObservableList<MemoriaView> memoriaViewObservableList;
    private MemoriaView memoriaView;

    public Integer addMemoria(Memoriadescriptivarv memoria) {
    ...
    public ObservableList<MemoriaView> getMemoriasDescriptiva(int idObra) {
        ...
        try {
            ...
            Query query = session.createQuery("FROM Memoriadescriptivarv WHERE nivelespecificoId =: idUO");
            query.setParameter("idUO", idObra);
            memoriadescriptivaArrayList = (ArrayList<Memoriadescriptivarv>) ((org.hibernate.query.Query) query).list();
