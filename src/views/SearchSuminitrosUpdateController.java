...
public class SearchSuminitrosUpdateController implements Initializable {

    BajoEspecificacionControllerComponetUpdate suministrosInRVControllerSearch;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(BajoEspecificacionControllerComponetUpdate suministrosInRVController) {
