...
public class SearchSuminitrosToChangeController implements Initializable {

    private static SessionFactory sf;
    CambioSuministroCertificacionController suministrostoChange;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(CambioSuministroCertificacionController suministrosInRVController) {

        loadDatos();
        suministrosViewObservableList = FXCollections.observableArrayList();
        suministrosViewObservableList = utilCalcSingelton.getSuministrosViewObservableList(suministrosInRVController.obraToChange.getSalarioBySalarioId().getTag());
