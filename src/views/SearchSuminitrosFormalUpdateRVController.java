...
public class SearchSuminitrosFormalUpdateRVController implements Initializable {

    private static SessionFactory sf;
    UpdateBajoEspecificacionRenglonController suministrosInRVControllerSearch;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(UpdateBajoEspecificacionRenglonController suministrosInRVController) {
