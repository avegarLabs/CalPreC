...
public class ConceptTarifasSalarialController implements Initializable {
    ...
    public void passDataToConfiguracion(TarifasSalarialController configuracionController) {
        configuracion = configuracionController;
        if (configuracion.tarConceptosList != null) {
            loadData();
            tableGroup.setItems(configuracion.tarConceptosList);
        } else {
            addDataToEmptyList();
        }
    }
