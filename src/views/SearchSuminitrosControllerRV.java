...
public class SearchSuminitrosControllerRV implements Initializable {

    private static SessionFactory sf;
    BajoEspecificacionControllerComponetRV suministrosInRVControllerSearch;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(BajoEspecificacionControllerComponetRV suministrosInRVController) {
