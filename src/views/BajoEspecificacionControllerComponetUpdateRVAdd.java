...
public class BajoEspecificacionControllerComponetUpdateRVAdd implements Initializable {

    private static SessionFactory sf;
    public Integer idObra;
    public Obra obraToCheck;
    SuministrosInRVUpdateRVController suministrosInRVUpdateController;
    BajoEspecificacionControllerComponetUpdateRVAdd bajoEspecificacionControllerComponetRVt;
    ...
    public void pasarDatos(SuministrosInRVUpdateRVController suministrosInRVController, int idObra) {
...
//        importe = Double.parseDouble(labelValue.getText()) * 100d / 100d;
    ...
    public void searchView(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("searhSuministroRVUpdateAdd.fxml"));
            Parent proot = loader.load();
            SearchSuminitrosControllerRVUpdateAdd controller = loader.getController();
    ...
    public void handleBajoAddSum(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("nuevoSuminitroFromBajoEspRVUpdateAdd.fxml"));
            Parent proot = loader.load();
            NuevoSuministroFromBajoRVUpdateControllerAdd controller = loader.getController();
