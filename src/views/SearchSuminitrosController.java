...
public class SearchSuminitrosController implements Initializable {

    private static SessionFactory sf;
    BajoEspecificacionControllerComponet suministrosInRVControllerSearch;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(BajoEspecificacionControllerComponet suministrosInRVController) {
