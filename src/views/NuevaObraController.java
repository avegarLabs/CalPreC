...
public class NuevaObraController implements Initializable {
    ...
    ObrasController obrasControllerTemp;
    NuevaObraController nuevaObraController;
    @FXML
    ...
    */
    ...
    public Integer AddNuevaObra(Obra obra) {
        ...
        System.out.println(obra.getCodigo() + " --- " + obra.getTarifaId() + " **** " + obra.getSalarioId());
    ...
    public void passController(ObrasController obrasController, String tipo) {
    ...
    public void handleAddNweObra(ActionEvent event) {
        ...
        try {
            ...
            String codeSalario = combo_normas.getValue().trim();
    ...
    public void handleAddEntidad(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("InsertarEntidad.fxml"));
            Parent proot = loader.load();
            InsertarEntidadController controller = loader.getController();
    ...
    public void handleAddInversionista(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("InsertarInversionista.fxml"));
            Parent proot = loader.load();
            InsertarInversionistaController controller = loader.getController();
            controller.pasarParametros(nuevaObraController);
