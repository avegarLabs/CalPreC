...
public class NuevoSuministroFromBajoFormalUpdateRVController implements Initializable {

    private static SessionFactory sf;
    UpdateBajoEspecificacionRenglonController bajoEspecificacionControllerComponetSum;
    @FXML
    ...
    public void addSuministroAction(javafx.event.ActionEvent event) {
        ...
        if (nuevo != null) {
            ...
            suministrosView = new SuministrosView(sumuni.getId(), sumuni.getCodigo(), sumuni.getDescripcion(), sumuni.getUm(), sumuni.getPeso(), sumuni.getPreciomn(), 0.0, sumuni.getGrupoescala(), sumuni.getTipo(), sumuni.getPertenece(), 0.0, utilCalcSingelton.createCheckBox(1));
        }
        field_codigo.clear();
    ...
    public void pasarParametros(UpdateBajoEspecificacionRenglonController bajoEspecificacionControllerComponet, String code, String descrip, String um, String precio) {
