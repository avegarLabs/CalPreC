...
public class DesgloseController implements Initializable {
    ...
    private Unidadobra getUnidadObra(int idUO) {
    ...
    private ObservableList<RenglonVarianteUOView> getRenglones(int idUO) {
        ...
        try {
            tx = session.beginTransaction();
            Query query = session.createQuery("FROM Unidadobrarenglon WHERE unidadobraId =: idUnidad");
            ...
            unidadobrarenglonArrayList.forEach(unidadobrarenglon -> {
                total = unidadobrarenglon.getCostMat() + unidadobrarenglon.getCostMano() + unidadobrarenglon.getCostEquip();
                totalCostRV += total;

                renglonVarianteUOView = new RenglonVarianteUOView(unidadobrarenglon.getRenglonvarianteId(), unidadobrarenglon.getRenglonvarianteByRenglonvarianteId().getCodigo(), unidadobrarenglon.getRenglonvarianteByRenglonvarianteId().getDescripcion(), unidadobrarenglon.getRenglonvarianteByRenglonvarianteId().getUm(), Math.round(unidadobrarenglon.getCantRv() * 100d) / 100d, Math.round(unidadobrarenglon.getCostMat() * 100d) / 100d, Math.round(unidadobrarenglon.getCostMano() * 100d) / 100d, Math.round(unidadobrarenglon.getCostEquip() * 100d) / 100d, Math.round(total * 100d) / 100d);
    ...
    private ObservableList<UOMaterialesView> getMateriales(int idUO) {
        ...
        try {
             ...
             *Recursos del tipo 1
             */
            Query query = session.createQuery("SELECT bajo.id, rc.codigo, rc.descripcion, rc.um, bajo.cantidad, rc.preciomn, bajo.costo FROM Bajoespecificacion bajo INNER JOIN Recursos rc ON bajo.idSuministro = rc.id WHERE bajo.unidadobraId =: idUnidad AND bajo.tipo = '1'");
            query.setParameter("idUnidad", idUO);
             ...
             * Juego de productos
             */
            Query query1 = session.createQuery("SELECT bajo.id, rc.codigo, rc.descripcion, rc.um, bajo.cantidad, rc.preciomn, bajo.costo FROM Bajoespecificacion bajo INNER JOIN Juegoproducto rc ON bajo.idSuministro = rc.id WHERE bajo.unidadobraId =: idUnidad AND bajo.tipo = 'J'");
            ...
            Query query2 = session.createQuery("SELECT bajo.id, rc.codigo, rc.descripcion, rc.um, bajo.cantidad, rc.preciomn, bajo.costo FROM Bajoespecificacion bajo INNER JOIN Suministrossemielaborados rc ON bajo.idSuministro = rc.id WHERE bajo.unidadobraId =: idUnidad AND bajo.tipo = 'S'");
...
*/
    ...
    private ObservableList<UOManoObraView> getManoObraUO(int id) {
        ...
        try {
             ...
             */
            Query query = session.createQuery("SELECT rc.id, rc.codigo, rc.descripcion, rc.um, rc.grupoescala, rc.preciomn, SUM(rvr.cantidas) FROM Renglonvariante  rv INNER JOIN Unidadobrarenglon uor ON rv.id = uor.renglonvarianteId INNER JOIN Renglonrecursos rvr ON rv.id = rvr.renglonvarianteId INNER JOIN Recursos rc ON rvr.recursosId = rc.id WHERE uor.unidadobraId =: idUO AND rc.tipo = '2' GROUP BY rc.id, rc.codigo, rc.descripcion, rc.um, rc.grupoescala, rc.preciomn");
    ...
    */
    private ObservableList<UOEquiposView> getEquiposUO(int id) {
        ...
        try {
            ...
            Query query = session.createQuery("SELECT rc.id, rc.codigo, rc.descripcion, rc.um,  SUM(rvr.cantidas), rc.preciomn FROM Renglonvariante  rv INNER JOIN Unidadobrarenglon uor ON rv.id = uor.renglonvarianteId INNER JOIN Renglonrecursos rvr ON rv.id = rvr.renglonvarianteId INNER JOIN Recursos rc ON rvr.recursosId = rc.id WHERE uor.unidadobraId =: idUO AND rc.tipo = '3' GROUP BY rc.id, rc.codigo, rc.descripcion, rc.um, rc.grupoescala, rc.preciomn");
            query.setParameter("idUO", id);
...
*/
    ...
    public void pasarDatos(int idUO) {
        ...
        label_title.setText("Estructura: " + unidadobra.getCodigo() + " - " + unidadobra.getDescripcion());
