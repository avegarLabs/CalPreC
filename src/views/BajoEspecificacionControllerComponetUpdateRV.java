...
public class BajoEspecificacionControllerComponetUpdateRV implements Initializable {

    private static SessionFactory sf;
    public Integer idObra;
    public Obra obraToCheck;
    SuministrosInRVUpdateRVController suministrosInRVUpdateController;
    BajoEspecificacionControllerComponetUpdateRV bajoEspecificacionControllerComponetRVt;
    ...
    public void pasarDatos(SuministrosInRVUpdateRVController suministrosInRVController, SumRVView sumRVView, int idObra) {
        ...
        obraToCheck = utSingelton.getObra(idObra);
...
//        importe = Double.parseDouble(labelValue.getText()) * 100d / 100d;
    ...
    public void searchView(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("searhSuministroRVUpdate.fxml"));
            Parent proot = loader.load();
            SearchSuminitrosControllerRVUpdate controller = loader.getController();
    ...
    public void handleBajoAddSum(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("nuevoSuminitroFromBajoEspRVUpdate.fxml"));
            Parent proot = loader.load();
            NuevoSuministroFromBajoRVUpdateController controller = loader.getController();
