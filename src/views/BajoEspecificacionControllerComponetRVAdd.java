...
public class BajoEspecificacionControllerComponetRVAdd implements Initializable {

    private static SessionFactory sf;
    public Integer idObra;
    public Obra obraToCheck;
    SuministrosInRVtoRVController suministrosInRVtoRVControllerSum;
    BajoEspecificacionControllerComponetRVAdd bajoEspecificacionControllerComponetRVt;
    ...
    public void pasarDatos(SuministrosInRVtoRVController suministrosInRVController, int idOb) {
...
//        importe = Double.parseDouble(labelValue.getText()) * 100d / 100d;
    ...
    public void searchView(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("searhSuministroRVAdd.fxml"));
            Parent proot = loader.load();
            SearchSuminitrosControllerRVAdd controller = loader.getController();
    ...
    public void handleBajoAddSum(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("nuevoSuminitroFromBajoEspRVAdd.fxml"));
            Parent proot = loader.load();
            NuevoSuministroFromBajoRVControllerAdd controller = loader.getController();
