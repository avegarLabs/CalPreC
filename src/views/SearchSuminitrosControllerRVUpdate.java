...
public class SearchSuminitrosControllerRVUpdate implements Initializable {

    private static SessionFactory sf;
    BajoEspecificacionControllerComponetUpdateRV suministrosInRVControllerSearch;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(BajoEspecificacionControllerComponetUpdateRV suministrosInRVController) {
