...
public class NuevoSuministroFromBajoFormalController implements Initializable {

    private static SessionFactory sf;
    BajoEspecificacionController bajoEspecificacionControllerComponetSum;
    @FXML
    ...
    public void addSuministroAction(javafx.event.ActionEvent event) {
        ...
        sumuni.setCodigo(field_codigo.getText().trim());
...
//        sumuni.setPreciomlc(Double.parseDouble(field_preciomlc.getText()));
        ...
        if (getRecursoId(sumuni.getCodigo()) == 0) {
            ...
            alert.setHeaderText("Información");
            alert.setContentText("Suministro ya existen en la obra");
            alert.showAndWait();
        }
    ...
    public void pasarParametros(BajoEspecificacionController bajoEspecificacionControllerComponet, String code, String descrip, String um, String precio) {
        ...
        recursosList = getRecursosList(idOb);
    }
