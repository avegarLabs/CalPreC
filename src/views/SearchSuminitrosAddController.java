...
public class SearchSuminitrosAddController implements Initializable {

    private static SessionFactory sf;
    BajoEspecificacionControllerComponetAdd suministrosInRVControllerSearch;
    @FXML
    private VBox box;
    @FXML
    ...
    public void pasController(BajoEspecificacionControllerComponetAdd suministrosInRVController) {

        loadDatos();
        suministrosViewObservableList = FXCollections.observableArrayList();
        suministrosViewObservableList = util.getSuministrosViewObservableList(suministrosInRVController.obraToCheck.getSalarioBySalarioId().getTag());
