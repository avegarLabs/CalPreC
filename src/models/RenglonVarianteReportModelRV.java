...
public class RenglonVarianteReportModelRV implements Comparable<RenglonVarianteReportModelRV> {
    ...
    public RenglonVarianteReportModelRV(Integer idEmpesa, String empresa, Integer idZona, String zona, Integer idObjeto, String objeto, Integer idNivel, String nivel, Integer idEspecialidad, String especialidad, Integer idSub, String subespecialidad, Integer idUnidad, String unidad, String descripUnidad, String uoUM, double cantUO, double uoTotal, int id, String codigo, String descripcion, String um, double cantidad, double costMat, double costMano, double costEquip, double total) {
    ...
    public int compareTo(RenglonVarianteReportModelRV o) {
