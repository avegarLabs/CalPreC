...
public class CertificacionUnidadObraView extends RecursiveTreeObject<CertificacionUnidadObraView> {
    ...
    public CertificacionUnidadObraView(Integer id, String codeUo, String descripcion, String um, Double cantidad, Double costmaterial, Double costmano, Double costequipo, Double salario, Double cucsalario, String desde, String hasta, double disponible, String idBrigada, String idGrupo, String idCadrilla) {
