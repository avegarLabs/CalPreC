...
public class CertificacionView extends RecursiveTreeObject<CertificacionView> {
    ...
    public CertificacionView(Integer id, String codeUo, String descripcion, String um, Double cantidad, Double costmaterial, Double costmano, Double costequipo, Double salario, Double cucsalario, String desde, String hasta, double disponible) {
