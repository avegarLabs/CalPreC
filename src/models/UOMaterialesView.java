...
public class UOMaterialesView extends RecursiveTreeObject<UOMaterialesView> {
    ...
    public UOMaterialesView(int id, String codigo, String descripcion, String um, double cantidad, double precio, double total) {
