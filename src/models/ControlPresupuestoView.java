...
public class ControlPresupuestoView {
    ...
    public ControlPresupuestoView(String empresa, String zona, String objeto, String nivel, String especialidad, String subEspecialidad, String uo, String descrip, String um, Double cant, Double total, Double hh, Double salario, Double avance, Double valorEjecutado, Double porEjecutarCost, Double porEjecutarHH, Double porEjecutarSalario, Double porciento) {
