...
public class planificaRenglonSingleton {

    private static planificaRenglonSingleton instancia = null;
    ...
    public static planificaRenglonSingleton getInstance() {
        if (instancia == null) {
            instancia = new planificaRenglonSingleton();
        }
        return instancia;
    }
