...
public class PresupuestoUORVN {
    ...
    public PresupuestoUORVN(Integer idEmpresa, String empresa, Integer idZona, String zona, Integer idObjeto, String objeto, Integer idNivel, String nivel, Integer idEspecialidad, String especialidad, Integer idSub, String subespecialidad, Integer idUnidad, String unidad, String descripUnidad, String uoUM, double cantUO, double uoTotal, int id, String codigo, String descripcion, String um, double cantidad, double material, double mano, double equip, double costMat, double costMano, double costEquip, double total, ArrayList<ConceptosReporte> bodyConceptos) {
