...
public class UOManoObraView extends RecursiveTreeObject<UOManoObraView> {
    ...
    public UOManoObraView(int id, String codigo, String descripcion, String um, String grupo, double cantidad, double precio, double total) {
