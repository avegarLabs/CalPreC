...
public class PresupuestoUORVNExtend {
    ...
    public PresupuestoUORVNExtend(Integer idEmpresa, String empresa, Integer idZona, String zona, Integer idObjeto, String objeto, Integer idNivel, String nivel, Integer idEspecialidad, String especialidad, Integer idSub, String subespecialidad, Integer idUnidad, String unidad, String descripUnidad, String uoUM, double cantUO, double uoTotal, int id, String codigo, String descripcion, String um, double cantidad, double material, double mano, double equip, double costMat, double costMano, double costEquip, double total, String sobreGrup, String rvGrup, String getSubreGrup, ArrayList<ConceptosReporte> bodyConceptos) {
