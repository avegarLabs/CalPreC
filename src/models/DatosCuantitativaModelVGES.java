...
public class DatosCuantitativaModelVGES implements Comparable<DatosCuantitativaModelVGES> {
    ...
    public String grupoScala;

    public DatosCuantitativaModelVGES(Integer idEmpresa, String empresa, Integer idZona, String zona, Integer idObjeto, String objeto, Integer idNivel, String nivel, Integer idEspecialidad, String especialidad, Integer idSubesp, String subespecialidad, String codigo, String descripcion, String um, String tipo, double cpo, double cpe, double cet, double otra, double cantidad, double precio, double preciomlc, double costoTotal, String grupoScala) {
    ...
    public String getGrupoScala() {
        return grupoScala;
    }

    public void setGrupoScala(String grupoScala) {
        this.grupoScala = grupoScala;
    }

    @Override
    public int compareTo(DatosCuantitativaModelVGES o) {
