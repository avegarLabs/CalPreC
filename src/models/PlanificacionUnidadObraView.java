...
public class PlanificacionUnidadObraView extends RecursiveTreeObject<PlanificacionUnidadObraView> {
    ...
    private StringProperty idBrigada;
    private StringProperty idGrupo;
    private StringProperty idCuadrilla;
    private DoubleProperty pendientes;


    public PlanificacionUnidadObraView(Integer id, String codeUo, String descripcion, String um, Double cantidad, Double costmaterial, Double costmano, Double costequipo, Double salario, Double cucsalario, String desde, String hasta, double disponible, String idBrigada, String idGrupo, String idCadrilla, Double pendientes) {
        ...
        this.idBrigada = new SimpleStringProperty(idBrigada);
        this.idGrupo = new SimpleStringProperty(idGrupo);
        this.idCuadrilla = new SimpleStringProperty(idCadrilla);
        this.pendientes = new SimpleDoubleProperty(pendientes);
    }
    ...
    public String getIdBrigada() {
        return idBrigada.get();
    }

    public void setIdBrigada(String idBrigada) {
        this.idBrigada.set(idBrigada);
    }

    public StringProperty idBrigadaProperty() {
        return idBrigada;
    }
    ...
    public String getIdCuadrilla() {
        return idCuadrilla.get();
    }

    public void setIdCuadrilla(String idCuadrilla) {
        this.idCuadrilla.set(idCuadrilla);
    }

    public StringProperty idCuadrillaProperty() {
        return idCuadrilla;
    }
    ...
    public DoubleProperty pendientesProperty() {
        return pendientes;
    }
}
