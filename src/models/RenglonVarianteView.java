...
public class RenglonVarianteView extends RecursiveTreeObject<RenglonVarianteView> {
    ...
    public RenglonVarianteView(int id, String codigo, String descripcion, String um, double costomat, double costmano, double costequip, double salario) {
