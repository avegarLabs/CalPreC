...
public class DatosCuantitativaGenreralModel {
    ...
    public DatosCuantitativaGenreralModel(Integer empresa, String zona, String objeto, String nivel, String especialidad, String subespecialidad, String codigo, String descripcion, String um, String tipo, double cpo, double cpe, double cet, double otra, double cantidad, double precio, double preciomlc, double costoTotal) {
    ...
    public boolean equals(Object o) {
        ...
        DatosCuantitativaGenreralModel that = (DatosCuantitativaGenreralModel) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(empresa, zona, objeto, nivel, especialidad, subespecialidad, codigo);
    }
}