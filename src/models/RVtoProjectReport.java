...
public class RVtoProjectReport {
    ...
    public RVtoProjectReport(int id, String codigo, String descripcion, String um, Double cantidad, double horas, double costMaterial, double costMano, double costEquipo, double costTotal, double avance, double costoEjecutado, double porCientEjec) {
        this.id = id;
        this.codigo = codigo;
