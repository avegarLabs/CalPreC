...
public class RenglonVarianteReportModelExtend {
    ...
    public double total;
    public String sobreGrup;
    public String rvGrup;
    public String getSubreGrup;
    ...
    public RenglonVarianteReportModelExtend(Integer idEmpesa, String empresa, Integer idZona, String zona, Integer idObjeto, String objeto, Integer idNivel, String nivel, Integer idEspecialidad, String especialidad, Integer idSub, String subespecialidad, Integer idUnidad, String unidad, String descripUnidad, String uoUM, double cantUO, double uoTotal, int id, String codigo, String descripcion, String um, double cantidad, double material, double mano, double equip, double costMat, double costMano, double costEquip, double total, String sobreGrup, String rvGrup, String getSubreGrup, String codeZona, String codeObjeto, String codeNivel, String codeEspecialidad, String codeSub) {
        ...
        this.total = total;
        this.sobreGrup = sobreGrup;
        this.rvGrup = rvGrup;
        this.getSubreGrup = getSubreGrup;
    ...
    public String getSobreGrup() {
        return sobreGrup;
    }

    public void setSobreGrup(String sobreGrup) {
        this.sobreGrup = sobreGrup;
    }

    public String getRvGrup() {
        return rvGrup;
    }

    public void setRvGrup(String rvGrup) {
        this.rvGrup = rvGrup;
    }

    public String getGetSubreGrup() {
        return getSubreGrup;
    }

    public void setGetSubreGrup(String getSubreGrup) {
        this.getSubreGrup = getSubreGrup;
    }
