...
public class CertificaRecursosRenglonesSingel {
    private static CertificaRecursosRenglonesSingel instancia = null;
    ...
    private CertificaRecursosRenglonesSingel() {
    }

    public static CertificaRecursosRenglonesSingel getInstance() {
        if (instancia == null) {
            instancia = new CertificaRecursosRenglonesSingel();
        }
        return instancia;
    }
