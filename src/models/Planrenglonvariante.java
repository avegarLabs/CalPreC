...
@Entity
public class Planrenglonvariante {
    private int id;
    ...
    private Date desde;
    private Date hasta;
    private Integer nivelespecificoId;
    private Integer renglonvarianteId;
    private Integer brigadaconstruccionId;
    ...
    public Integer getNivelespecificoId() {
        return nivelespecificoId;
    }

    public void setNivelespecificoId(Integer nivelespecificoId) {
        this.nivelespecificoId = nivelespecificoId;
    }

    @Basic
    @Column(name = "renglonvariante__id", nullable = false)
    public Integer getRenglonvarianteId() {
        return renglonvarianteId;
    }

    public void setRenglonvarianteId(Integer renglonvarianteId) {
        this.renglonvarianteId = renglonvarianteId;
    }

    @Basic
    @Column(name = "brigadaconstruccion__id", nullable = false)
    public Integer getBrigadaconstruccionId() {
        return brigadaconstruccionId;
    }

    public void setBrigadaconstruccionId(Integer brigadaconstruccionId) {
    ...
    public boolean equals(Object o) {
        ...
        Planrenglonvariante that = (Planrenglonvariante) o;
        return id == that.id &&
