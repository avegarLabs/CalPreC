...
public class DatosCuantitativaModel {
    ...
    public DatosCuantitativaModel(Integer idEmpresa, String empresa, Integer idZona, String zona, Integer idObjeto, String objeto, Integer idNivel, String nivel, Integer idEspecialidad, String especialidad, Integer idSubesp, String subespecialidad, String codigo, String descripcion, String um, String tipo, double cpo, double cpe, double cet, double otra, double cantidad, double precio, double preciomlc, double costoTotal) {
...
/*
    @Override
    public int compareTo(DatosCuantitativaModel o) {
