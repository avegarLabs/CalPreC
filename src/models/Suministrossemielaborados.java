...
@Entity
public class Suministrossemielaborados {
    private int id;
    ...
    private Collection<Renglonsemielaborados> renglonsemielaboradosById;
    private Collection<Semielaboradosrecursos> semielaboradosrecursosById;
    private String pertenec;
    ...
    public boolean equals(Object o) {
        ...
        Suministrossemielaborados that = (Suministrossemielaborados) o;
        return id == that.id &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, descripcion, codigo, um, peso, preciomn, preciomlc, costomat, costmano, costequip, ho, ha, he, cemento, arido, asfalto, carga, prefab, mermaprod, mermatrans, mermamanip, otrasmermas);
    }

    @OneToMany(mappedBy = "suministrossemielaboradosBySuministrossemielaboradosId")
    public Collection<Renglonsemielaborados> getRenglonsemielaboradosById() {
        return renglonsemielaboradosById;
    }

    public void setRenglonsemielaboradosById(Collection<Renglonsemielaborados> renglonsemielaboradosById) {
        this.renglonsemielaboradosById = renglonsemielaboradosById;
    }

    @OneToMany(mappedBy = "suministrossemielaboradosBySuministrossemielaboradosId")
    public Collection<Semielaboradosrecursos> getSemielaboradosrecursosById() {
        return semielaboradosrecursosById;
    }

    public void setSemielaboradosrecursosById(Collection<Semielaboradosrecursos> semielaboradosrecursosById) {
        this.semielaboradosrecursosById = semielaboradosrecursosById;
    }

    @Basic
    @Column(name = "pertenec", nullable = true, length = -1)
    public String getPertenec() {
        return pertenec;
    }

    public void setPertenec(String pertenec) {
        this.pertenec = pertenec;
    }
