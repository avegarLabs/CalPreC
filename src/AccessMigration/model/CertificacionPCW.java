...
public class CertificacionPCW {
    ...
    public CertificacionPCW(String empresa, String zona, String objeto, String nivel, String especialidad, String subEspecialidad, String codeUO, String brigada, String grupo, String cuadrilla, String desde, String hasta, double cantidda, double costomaterial, double costomano, double costoequipo, double salario, double salariocuc) {
